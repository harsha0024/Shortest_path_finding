...
count_text = font.render(f'Step Count: {count}',True, (255,0,0))
count_text_rect = count_text.get_rect()
count_text_rect.topleft = (10,10)
elapsed_time_text = font.render(f'Elapsed time: {time} seconds',True, (255,0,0))
elapsed_time_text_rect = elapsed_time_text.get_rect()
elapsed_time_text_rect.topleft = (10,40)
...
def draw(window, grid, rows, width):
    ...
    window.blit(elapsed_time_text , elapsed_time_text_rect)
